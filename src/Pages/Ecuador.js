...
function Ecuador() {
  ...
  return (
    <div className="ecuador"> 
        ...
        <p className="sectionparagraphs">This project was recently adopted by the UCLA chapter in August 2025. With an estimated budget of $16,250, our chapter is working towards securing funds for construction while building a team of committed engineering students. An assessment trip is tentatively planned for Spring 2025 to assess the current state of the water system and to develop a better understanding of this community's issues with it. We are just getting started, so be on the lookout for more details! Thank you for supporting this project.</p>
    </div>
        )
    }
